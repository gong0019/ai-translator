...
## GRAMMAR
1. Place every predicate at the end of its Korean clause and assign topic, subject, object, location, direction, and instrument particles from semantic roles.
2. Preserve every Chinese agent, patient, recipient, cause, condition, comparison, quantity, and negation.
3. Use one Korean speech level throughout each speaker’s text. Preserve stated honorific relations and do not create unexpressed honorific relations.
4. Translate each Chinese idiom into an explicit Korean proposition containing every source information unit.
